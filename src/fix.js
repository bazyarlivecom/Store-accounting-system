...
const startIndex = lines.findIndex(l => l.includes('c                  {/* Header info */}'));
const endIndex = lines.findIndex(l => l.includes('{/* --- COMPLETELY DIFFERENT CONDITIONAL RENDERING END --- */}pe="button"'));
